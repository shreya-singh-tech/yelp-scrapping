...
myProxy = ['208.80.28.208','172.106.11.102','207.157.220.8']
...
def get_review(url, res_name, res_address):
    ...
    try:
        ...
        total_pages = driver.find_element_by_xpath('/html/body/div[2]/div[3]/yelp-react-root/div/div[3]/div/div/div[2]/div/div[1]/div[2]/section[2]/div[2]/div/div[4]/div[2]/span')
        time.sleep(1)
        total_page = total_pages.text
    ...
    for page_np in range(num_page):
        ...
        if page_np == num_page-1:
            ...
            clickable_xpath = ('//*[@id="wrap"]/div[3]/yelp-react-root/div/div[3]/div/div/div[2]/div/div[1]/div[2]/section[2]/div[2]/div/div[4]/div[1]/div/div['+click_link+']/span/a/span')
            time.sleep(2)
            driver.find_element_by_xpath(clickable_xpath).click()
